...
import { MuiSwitch, MuiFilter, MuiPagination } from "../../../components/Mui";
import "./styles.scss";
const daysOptions = [
    ...
    renderTriggers = triggers => {
        ...
        if (triggers && triggers.length > 0) {
            return triggers.map((t, i) => (
                <Table.Row key={i} className="trigger-row">
                    ...
                    <Table.Cell>
                        {t.type ? triggerTypes[t.type].text : ""}
                    </Table.Cell>
                    <Table.Cell>
                        <MuiSwitch></MuiSwitch>
                    </Table.Cell>
            ...
            <Block className="main-container trigger-container mt-0">
                ...
                <Block className="inner-box-main">
                    <div className="d-flex justify-content-between">
                        <h2 className="float-left mt-3 mb-4 p-0">Triggers</h2>
                        <Block className="addButtonWrapper">
                            <Link to={`/page/${this.props.match.params.id}/triggers/add`}>
                                    ...
                                    >
                                        ...
                                        <span class="font-size-2">Add New Trigger</span>
                                    </MuiButton>
                            </Link>
                        </Block>
                    </div>
                    ...
                    <Block className="trigger-tbl">
                        <Block className="toolbar d-flex justify-content-between">
                          <Dropdown
                            loading={daysLoading}
                            value={days}
                            options={daysOptions}
                      ...
                      <Block className="paginationCol">
                          {triggers && triggers.length > 0 && (
                              ...
                              // />
                              <MuiPagination 
                                count={Math.ceil(triggers.length / 10)} 
                                shape="rounded"
                                onChange={(event, page) => {
                                  const pageTriggers = triggers.slice(10 * (page - 1), 10 * page);
                                  this.setState({ pageTriggers })
                                }}/>
                          )}
                      </Block>
                ...
                <Block className="triggers-aside-right">
                    <MuiPaper>
